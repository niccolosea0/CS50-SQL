-- In 6.sql, write a SQL query to return the first name, last name, and debut date of players born in Pittsburgh,
...
FROM "players"
WHERE "birth_state" IS 'PA' AND "birth_city" IS 'Pittsburgh'
